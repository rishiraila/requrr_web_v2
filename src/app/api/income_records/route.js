...
//   // Step 2: If plan has a renewal limit, check renewal count even if is_recurring is false
//   const checkRenewals = is_recurring || max_renewals !== null;

//   if (checkRenewals && max_renewals !== null) {
//     const [countResult] = await db.query(
//       `SELECT COUNT(*) AS total FROM income_records 
//        WHERE user_id = ? AND is_recurring = 1 
...
export async function POST(req) {
  ...
  // Step 2: If plan has a renewal limit, check total entries in that period
