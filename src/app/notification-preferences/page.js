              ...
              <div className="notification-container">
                <h1 className="notification-header">
                  <span>
                    <i
                      ...
                      style={{ fontSize: "30px", color: "#2563EB" }}
                    ></i>
                  </span>{" "}
                ...
                <div className="section mb-4">
                  ...
                  <div className="form-check form-switch d-flex justify-content-between align-items-center mb-2 p-3 border border-top-0 border-start-0 border-end-0">
                    <label className="form-check-label" htmlFor="remind30">
                      <h5 style={{ marginBottom: "5px" }}>
                        <b>30 days before expiry</b>
                      </h5>
                      <p>Send a reminder 30 days before renewal is due</p>
                    </label>
                    <input
                      type="checkbox"
                      className="form-check-input"
                      id="remind30"
                      checked={prefs.remind_30_days_before}
                      onChange={() => handleToggle("remind_30_days_before")}
                    />
                  </div>

                  <div className="form-check form-switch d-flex justify-content-between align-items-center mb-2 p-3 border border-top-0 border-start-0 border-end-0">
                    <label className="form-check-label" htmlFor="remind15">
                      <h5 style={{ marginBottom: "5px" }}>
                        <b>15 days before expiry</b>
                      </h5>
                      <p>Send a reminder 15 days before renewal is due</p>
                    </label>
                    <input
                      type="checkbox"
                      className="form-check-input"
                      id="remind15"
                      checked={prefs.remind_15_days_before}
                      onChange={() => handleToggle("remind_15_days_before")}
                    />
                  </div>

                  <div className="form-check form-switch d-flex justify-content-between align-items-center mb-2 p-3 border border-top-0 border-start-0 border-end-0">
                    <label className="form-check-label" htmlFor="remind7">
                      <h5 style={{ marginBottom: "5px" }}>
                        <b>7 days before expiry</b>
                      </h5>
                      <p>Send a reminder 7 days before renewal is due</p>
                    </label>
                    <input
                      type="checkbox"
                      className="form-check-input"
                      id="remind7"
                      checked={prefs.remind_7_days_before}
                      onChange={() => handleToggle("remind_7_days_before")}
                    />
                  </div>
                  ...
                  <div className="form-check form-switch d-flex justify-content-between align-items-center mb-2 p-3 border border-top-0 border-start-0 border-end-0">
                    <label className="form-check-label" htmlFor="overdue">
                      <h5 style={{ marginBottom: "5px" }}>
                        <b>Overdue renewals</b>
                      </h5>
                      <p>Send reminders for overdue renewals</p>
                    </label>
                    <input
                      type="checkbox"
                      className="form-check-input"
                      id="overdue"
                      checked={prefs.remind_overdue}
                      onChange={() => handleToggle("remind_overdue")}
                    />
                  </div>
                </div>
                ...
                <div className="section mb-4">
                  ...
                  <div className="form-check form-switch d-flex justify-content-between align-items-center mb-2 p-3 border border-top-0 border-start-0 border-end-0">
                    ...
                    >
                      ...
                      <p>Show notifications in the dashboard</p>
                    </label>
                    <input
                      type="checkbox"
                      className="form-check-input"
