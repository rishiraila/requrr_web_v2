...
$(function () {
  ...
  if (dtUserTable.length) {
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            var $role = full['role'];
            var roleBadgeObj = {
              Subscriber: '<i className="ri-user-line ri-22px text-primary me-2"></i>',
              Author: '<i className="ri-vip-crown-line ri-22px text-warning me-2"></i>',
              Maintainer: '<i className="ri-pie-chart-line ri-22px text-success me-2"></i>',
              Editor: '<i className="ri-edit-box-line ri-22px text-info me-2"></i>',
              Admin: '<i className="ri-computer-line ri-22px text-danger me-2"></i>'
            };
            return (
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<button className="btn btn-sm btn-icon btn-text-secondary rounded-pill delete-record waves-effect waves-light"><i className="ri-delete-bin-7-line ri-20px"></i></button>' +
              '<a href="' +
              userView +
              '" className="btn btn-sm btn-icon btn-text-secondary rounded-pill waves-effect waves-light"><i className="ri-eye-line ri-20px"></i></a>' +
              '<button className="btn btn-sm btn-icon btn-text-secondary rounded-pill dropdown-toggle hide-arrow waves-effect waves-light" data-bs-toggle="dropdown"><i className="ri-more-2-fill ri-20px"></i></button>' +
      ...
      buttons: [
        {
          ...
          text: '<i className="ri-download-line ri-16px me-1"></i> <span className="d-none d-sm-inline-block">Export</span>',
          buttons: [
            {
              extend: 'print',
      ...
      initComplete: function () {
        ...
        this.api()
          ...
          .every(function () {
            var column = this;
            var select = $(
              '<select id="UserRole" className="form-select text-capitalize form-select-sm"><option value=""> Select Role </option></select>'
            )
              .appendTo('.user_role')
              .on('change', function () {
    ...
    $('.add-new').html(
      "<button className='btn btn-primary' data-bs-toggle='modal' data-bs-target='#editUser'><i className='ri-add-line me-0 me-sm-1'></i><span className= 'd-none d-sm-inline-block'> Add User </span ></button>"
    );
  }
