      ...
      >
        <div className="app-brand demo ">
          ...
          <Link
            ...
            className="layout-menu-toggle menu-link text-large ms-auto hideOnPc "
          >
            <svg
              width="24"
              height="24"
        ...
        <ul className="menu-inner py-1">
          ...
          <li className={`menu-item ${pathname == "/Clients" ? "active" : ""}`}>
            <Link href="/Clients" className="menu-link ">
              <i className="menu-icon tf-icons ri-group-line"></i>
              <div>Clients</div>
              <div className="badge bg-danger rounded-pill ms-auto">
                {clientCount}
              </div>
            </Link>
          </li>
          ...
          <li
            className={`menu-item ${pathname == "/Services" ? "active" : ""}`}
          >
          ...
          <li
            className={`menu-item ${pathname == "/Renewals" ? "active" : ""}`}
          >
            <Link href="/Renewals" className="menu-link ">
          ...
          <li
            className={`menu-item ${
              pathname.startsWith("/Recurring_expense") ? "active" : ""
            }`}
          >
            <Link href="/Recurring_expense" className="menu-link ">
              <i className="menu-icon tf-icons ri-repeat-line"></i>
          ...
          >
            <Link href="/Calendar" className="menu-link ">
